...
class BadgeDrawable extends Drawable {
    ...
    BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.icon_text_size);
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), android.R.color.black));
